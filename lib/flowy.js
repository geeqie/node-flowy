 ...
 *
 * The Group also becomes resolved when the first error occures during
...
Group.prototype.slot = function slot() {
    return this._reserveSlot(function(err, data) {
        return data;
    });
};
...
Group.prototype.slotGroup = function() {
    var group = new Group();
    group.then(this._reserveSlot(function(/*err, data...*/) {
...
function composeSteps(/*step1, ..., stepN*/) {
    ...
    return function(/*arg1, ... argN, callback*/) {
        ...
        steps.reduce(
            ...
            }, Group.when.apply(null, [null].concat(initArgs))
        ).end(callback);
    };
};
