 ...
 */
Group.prototype.whatever = function(callback) {
...
Group.prototype._resolve = function(err) {
    ...
    this.resolved = err ? 'rejected' : 'fulfilled';
    this.slots[0] = err;
 ...
 */
Group.prototype._queueCallbacks = function(callback, errback) {
    var context = new Group();
    this.callbacks.push(context.wrap(callback));
    this.errbacks.push(context.wrap(errback));
    this._ensureCallbacksTriggered();
    return context;
};
